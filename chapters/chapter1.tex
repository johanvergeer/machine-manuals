...
\setsectiontitle{Transport of the Machine}
\setrevision{7631}
...
\setsectiontitle{Installation of the Machine}
...
\setsectiontitle{Setup Plan and Workspace Layout}
...
\begin{description}[labelwidth=0cm, labelindent=0cm, leftmargin=0cm]
    \item \adjustbox{valign=c}{\includegraphics[height=1cm]{chapter1/icon_electrician_access.jpg}} \hspace{0.5cm} Electrician access
    \item \adjustbox{valign=c}{\includegraphics[height=1cm]{chapter1/icon_coverage_area.jpg}} \hspace{0.5cm} Coverage area (F)
    \item \adjustbox{valign=c}{\includegraphics[height=1cm]{chapter1/icon_operator_position.jpg}} \hspace{0.5cm} Operator position
\end{description}
...
\setsectiontitle{Dimensional Drawing of the Machine}
...
\setsectiontitle{Removal of the Rust Protection Agent}
...
\setsectiontitle{Spindle Head Oil Fill}
\setrevision{5628}
...
\setsectiontitle{Connecting to the Electrical Network}
\setrevision{7631}
...
\setsectiontitle{Commissioning Checklist}
\setrevision{859}
