...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{diagram_removal_of_rust_protection_agent.jpg}
    \caption{}
\end{figure}
...
\notebox{CAUTION}{Verify that the machine is level in the Z-axis using a spirit level, and adjust if necessary.\footnotemark}

\footnotetext{See Sheet 1.03-1.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{spindle_oil_fill_diagram.jpg} % Replace with your image filename
    \caption{}
\end{figure}
...
\begin{figure}[htp] % Top alignment for the figure
    ...
    \begin{minipage}[t]{.4\linewidth} % Adjust the width for the image
        ...
        \raisebox{-\height}{% Top-align the image
            \includegraphics[width=\linewidth]{electrical_connection_diagram.jpg}
        }
