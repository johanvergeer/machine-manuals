...
\setsectiontitle{Functional Testing / Trial Run}
\setrevision{7631}
...
\setsectiontitle{Vertical Milling Head without Quill Feed}
...
\setsectiontitle{Reworking of Standard Tool Shafts}
\setrevision{859}
...
\setsectiontitle{Manual Adjustment of the Machine Slide}
\setrevision{7631}
...
\setsectiontitle{Hydraulic Plan and equipment list}
\setcounter{section}{18}

\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{chapter3/hydraulic_diagram.jpg}
\end{figure}
...
\begin{textblock*}{3cm}(11.3cm,4.6cm)
...
\begin{textblock*}{5cm}(3.8cm,12.1cm)
...
\setsectiontitle{Coolant System}
\setrevision{7631}
